...
<html>
	<head>
        ...
        <script type="text/javascript">
            ...
            var count_row_slices=10;
            var count_col_slices=10;
            ...
            function image_loaded(the_image){
                ...
                switch ($('#game_difficulty').val()) {
                    ...
                    default:
                        ...
                        count_col_slices = 4;
                        random_steps = 50;
                        $('#game_difficulty').val('standard');
                }
                the_main_image=the_image;
                img_height=$(the_image).height();
                img_width=$(the_image).width();
                each_slice_width=img_width/count_col_slices;
                each_slice_height=img_height/count_row_slices;
            ...
            function do_randomize(){
                ...
                while(i < random_steps){
                    var slice_number = getRandomInt(0,(count_col_slices*count_row_slices)-1);
            ...
            $(document).on("click",".each_slice", function(){
                if(solving) return;
                if(!game_started){
            ...
            function checkmate(caller){
                ...
                if(caller == "user"){
                    ...
                    if(i==count_row_slices*count_col_slices){
	...
	<body>
		<div>
            ...
            Mode
            <select id="game_difficulty" onchange="image_loaded(the_main_image);">
		...
		<div id="game_board" style="overflow:auto;width:1000px;margin:0 auto;">
		...
		<script>
            $('#game_board').append('\
                <div id="the_puzzle_final">\
                    <img src="'+image_array[current_image]+'" onload="image_loaded(this)" id="base_image" />\
                </div>\
                ');
        </script>
